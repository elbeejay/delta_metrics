...
wetlen = []						# Empty list for wetted length data
...
for k in range(0,NUMEND-NUMSTART):
	wetlen.append(fractions[k]['length_wet'])
...
ax.set(xlabel = 'Time', ylabel = 'Wet Length', title = 'Shuffled Strata Wet Length Metrics')

...
wetlen = []						# Empty list for channel frac data
...
for k in range(0,NUMEND-NUMSTART):
	wetlen.append(fractions[k]['frac_channel'])
...
ax.set(xlabel = 'Time', ylabel = 'Channel Fraction', title = 'Shuffled Strata Channel Fraction Metrics')

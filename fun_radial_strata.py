...
## Load and plot radial stratigraphy

## Set radius
#r0 = 25.0

#bdata = load_matlab_data('ForHollyMichael/','data2100') # Pick file to use
#bstrata = bdata['strata'] 	# Loading 3D strata array

# Load and plot radial stratigraphy and XY plane slice

def rad_strata(r0,bstrata):
	# r0 is radius input
	# bstrata is 3D strata array input 
